...
void * esp32_mesh_create_packet(void *dst_addr, void *src_addr,
                                enum mesh_usr_proto_type proto, uint16_t data_len,
                                bool option, uint16_t ot_len);
...
bool esp32_mesh_get_option(struct mesh_header_format *head,
                           ...
                           struct mesh_header_option_format **option);
bool esp32_mesh_get_usr_data(struct mesh_header_format *head,
                             void **usr_data, uint16_t *data_len);
bool esp32_mesh_set_usr_data(struct mesh_header_format *head,
                             void *usr_data, uint16_t data_len);
...
bool esp32_mesh_get_node_info(enum mesh_node_t type,
                              void **info, uint16_t *count);
bool esp32_mesh_get_router(wifi_sta_config_t *router);
bool esp32_mesh_set_router(wifi_sta_config_t *router);
bool esp32_mesh_encrypt_init(wifi_auth_mode_t mode, void *passwd, uint8_t pw_len);
