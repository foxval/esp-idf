...
void BTA_DmBleGapReadPHY(UINT16 conn_idx)
{
...
void BTA_DmBleGapSetPreferedPHY(UINT16 conn_idx,
                                               tBTA_DM_BLE_GAP_PHY_MASK tx_phy_mask,
                                               tBTA_DM_BLE_GAP_PHY_MASK rx_phy_mask,
                                               UINT16 phy_operations)
{
    ...
    if ((p_msg = (tBTA_DM_API_SET_PER_PHY *) osi_malloc(sizeof(tBTA_DM_API_SET_PER_PHY))) != NULL) {
        ...
        p_msg->conn_idx = conn_idx;
        p_msg->tx_phy_mask = tx_phy_mask;
        p_msg->rx_phy_mask = rx_phy_mask;
        p_msg->phy_operations = phy_operations;
        //start sent the msg to the bta system control moudle
        bta_sys_sendmsg(p_msg);
    }
}
...
void BTA_DmBleGapSetExtScanParams(tBTA_DM_BLE_EXT_SCAN_PARAMS *params, UINT8 limit)
{
