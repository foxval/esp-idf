                                                ...
                                                tBTA_DM_BLE_5_GAP_CB_PARAMS *params)
{
    ...
    switch(event) {
        ...
        case BTA_DM_BLE_5_GAP_PHY_UPDATE_COMPLETE_EVT:
            ...
            param.phy_update.status = btc_btm_status_to_esp_status(params->phy_update.phy_update.status);
            param.phy_update.conn_idx = params->phy_update.phy_update.conn_idx;
            param.phy_update.tx_phy = params->phy_update.phy_update.tx_phy;
            param.phy_update.rx_phy = params->phy_update.phy_update.rx_phy;
            break;
...
void btc_gap_ble_call_handler(btc_msg_t *msg)
{
    ...
    case BTC_GAP_BLE_READ_PHY:
        ...
        BTA_DmBleGapReadPHY(arg_5->read_phy.conn_idx);
        break;
    ...
    case BTC_GAP_BLE_SET_DEF_PHY:
        ...
        BTA_DmBleGapSetPreferedPHY(arg_5->set_def_phy.conn_idx,
                                   arg_5->set_def_phy.tx_phy_mask,
                                   arg_5->set_def_phy.rx_phy_mask,
                                   arg_5->set_def_phy.phy_operations);
        break;
    ...
    case BTC_GAP_BLE_SET_EXT_SCAN_PARAMS: {
        ...
        BTA_DmBleGapSetExtScanParams(&params, arg_5->set_ext_scan_params.limit);
        break;
    }
