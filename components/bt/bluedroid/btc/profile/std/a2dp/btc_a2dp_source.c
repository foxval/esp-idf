    ...
    while (nb_frame) {
        ...
        do {
            ...
            if (btc_media_aa_read_feeding()) {
                ...
                A2D_SbcChkFrInit(a2dp_source_local_param.btc_aa_src_cb.encoder.pu8Packet);
                A2D_SbcDescramble(a2dp_source_local_param.btc_aa_src_cb.encoder.pu8Packet, a2dp_source_local_param.btc_aa_src_cb.encoder.u16PacketLength);
