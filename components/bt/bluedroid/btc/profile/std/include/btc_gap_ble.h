...
typedef enum {
    ...
    BTC_GAP_BLE_SET_EXT_ADV_RAND_ADDR = 30,
    ...
    BTC_GAP_BLE_PERIODIC_ADV_START = 40,
    ...
    BTC_GAP_BLE_PERIODIC_ADV_ADD_DEV_TO_LIST = 45,
