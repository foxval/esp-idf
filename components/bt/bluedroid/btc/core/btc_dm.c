...
static void btc_dm_ble_auth_cmpl_evt (tBTA_DM_AUTH_CMPL *p_auth_cmpl)
{
    ...
    if (p_auth_cmpl->success) {
        ...
        BTC_TRACE_DEBUG ("%s, -  btc_dm_cb.pairing_cb.bd_addr: %08x%04x", __func__,
                             (btc_dm_cb.pairing_cb.bd_addr[0] << 24) + (btc_dm_cb.pairing_cb.bd_addr[1] << 16) + (btc_dm_cb.pairing_cb.bd_addr[2] << 8) + btc_dm_cb.pairing_cb.bd_addr[3],
                             (btc_dm_cb.pairing_cb.bd_addr[4] << 8) + btc_dm_cb.pairing_cb.bd_addr[5]);
