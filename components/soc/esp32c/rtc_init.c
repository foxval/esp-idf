...
void rtc_init(rtc_config_t cfg)
{
    ...
    if (cfg.clkctl_init) {
        ...
        DPORT_CLEAR_PERI_REG_MASK(DPORT_PRO_CACHE_MMU_POWER_CTRL_REG, DPORT_PRO_CACHE_MMU_MEM_FORCE_ON);
#if !CONFIG_FREERTOS_UNICORE
        DPORT_CLEAR_PERI_REG_MASK(DPORT_APP_CACHE_MMU_POWER_CTRL_REG, DPORT_APP_CACHE_MMU_MEM_FORCE_ON);
#endif
