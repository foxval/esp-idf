...
#define DPORT_PRO_USB_INT_MAP_REG          (DR_REG_INTERRUPT_BASE + 0x0C0)
/* DPORT_PRO_USB_INT_MAP : R/W ;bitpos:[4:0] ;default: 5'd16 ; */
/*description: */
#define DPORT_PRO_USB_INT_MAP  0x0000001F
#define DPORT_PRO_USB_INT_MAP_M  ((DPORT_PRO_USB_INT_MAP_V)<<(DPORT_PRO_USB_INT_MAP_S))
#define DPORT_PRO_USB_INT_MAP_V  0x1F
#define DPORT_PRO_USB_INT_MAP_S  0
...
#define DPORT_SYSTIMER_PRO_TARGET0_INT_MAP_REG          (DR_REG_INTERRUPT_BASE + 0x118)
...
#define DPORT_SYSTIMER_PRO_TARGET1_INT_MAP_REG          (DR_REG_INTERRUPT_BASE + 0x11C)
...
#define DPORT_SYSTIMER_PRO_TARGET2_INT_MAP_REG          (DR_REG_INTERRUPT_BASE + 0x120)
...
/* DPORT_PRO_NMI_MASK_HW : R/W ;bitpos:[1] ;default: 1'b1 ; */
/*description: */
