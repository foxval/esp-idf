...
/* DPORT_ENABLE_DOWNLOAD_MANUAL_ENCRYPT : R/W ;bitpos:[4] ;default: 1'b0 ; */
/*description: */
#define DPORT_ENABLE_DOWNLOAD_MANUAL_ENCRYPT  (BIT(4))
#define DPORT_ENABLE_DOWNLOAD_MANUAL_ENCRYPT_M  (BIT(4))
#define DPORT_ENABLE_DOWNLOAD_MANUAL_ENCRYPT_V  0x1
#define DPORT_ENABLE_DOWNLOAD_MANUAL_ENCRYPT_S  4
/* DPORT_ENABLE_DOWNLOAD_DB_ENCRYPT : R/W ;bitpos:[3] ;default: 1'b0 ; */
/*description: */
#define DPORT_ENABLE_DOWNLOAD_DB_ENCRYPT  (BIT(3))
#define DPORT_ENABLE_DOWNLOAD_DB_ENCRYPT_M  (BIT(3))
#define DPORT_ENABLE_DOWNLOAD_DB_ENCRYPT_V  0x1
#define DPORT_ENABLE_DOWNLOAD_DB_ENCRYPT_S  3
/* DPORT_ENABLE_DOWNLOAD_DB_DECRYPT : R/W ;bitpos:[2] ;default: 1'b0 ; */
/*description: */
#define DPORT_ENABLE_DOWNLOAD_DB_DECRYPT  (BIT(2))
#define DPORT_ENABLE_DOWNLOAD_DB_DECRYPT_M  (BIT(2))
#define DPORT_ENABLE_DOWNLOAD_DB_DECRYPT_V  0x1
#define DPORT_ENABLE_DOWNLOAD_DB_DECRYPT_S  2
/* DPORT_ENABLE_DOWNLOAD_ICB_DECRYPT : R/W ;bitpos:[1] ;default: 1'b0 ; */
/*description: */
#define DPORT_ENABLE_DOWNLOAD_ICB_DECRYPT  (BIT(1))
#define DPORT_ENABLE_DOWNLOAD_ICB_DECRYPT_M  (BIT(1))
#define DPORT_ENABLE_DOWNLOAD_ICB_DECRYPT_V  0x1
#define DPORT_ENABLE_DOWNLOAD_ICB_DECRYPT_S  1
