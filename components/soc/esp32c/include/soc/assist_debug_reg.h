...
#define ASSIST_DEBUG_INTERRUPT_EAW              ((ASSIST_DEBUG_BASE) +0x04)
...
#define ASSIST_DEBUG_PRO_SP_MIN                 ((ASSIST_DEBUG_BASE) +0x30)
#define ASSIST_DEBUG_PRO_SP_MAX                 ((ASSIST_DEBUG_BASE) +0x34)
#define ASSIST_DEBUG_PRO_SP_PC                  ((ASSIST_DEBUG_BASE) +0x38)
#define ASSIST_DEBUG_PRO_SP_SP                  ((ASSIST_DEBUG_BASE) +0x3C)
