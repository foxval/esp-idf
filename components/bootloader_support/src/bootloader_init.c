...
static void IRAM_ATTR flash_gpio_configure(const esp_image_header_t* pfhdr)
{
    ...
    switch (pfhdr->spi_speed) {
        case ESP_IMAGE_SPI_SPEED_80M:
            ...
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(0), SPI_MEM_DIN0_MODE_V, 1, SPI_MEM_DIN0_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(0), SPI_MEM_DIN1_MODE_V, 1, SPI_MEM_DIN1_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(0), SPI_MEM_DIN2_MODE_V, 1, SPI_MEM_DIN2_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(0), SPI_MEM_DIN3_MODE_V, 1, SPI_MEM_DIN3_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(0), SPI_MEM_DIN0_NUM_V, 0, SPI_MEM_DIN0_NUM_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(0), SPI_MEM_DIN1_NUM_V, 0, SPI_MEM_DIN1_NUM_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(0), SPI_MEM_DIN2_NUM_V, 0, SPI_MEM_DIN2_NUM_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(0), SPI_MEM_DIN3_NUM_V, 0, SPI_MEM_DIN3_NUM_S);
            REG_SET_BIT(SPI_MEM_USER_REG(0), SPI_MEM_USR_DUMMY);
            REG_SET_BIT(SPI_MEM_USER_REG(0), SPI_MEM_CS_SETUP);
            esp_rom_spiflash_config_clk(0, 0);
            SET_PERI_REG_BITS(SPI_MEM_USER1_REG(1), SPI_MEM_USR_DUMMY_CYCLELEN_V, spi_cache_dummy + FLASH_IO_MATRIX_DUMMY_80M - 2,
                    SPI_MEM_USR_DUMMY_CYCLELEN_S);  //DUMMY
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(1), SPI_MEM_DIN0_MODE_V, 1, SPI_MEM_DIN0_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(1), SPI_MEM_DIN1_MODE_V, 1, SPI_MEM_DIN1_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(1), SPI_MEM_DIN2_MODE_V, 1, SPI_MEM_DIN2_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_MODE_REG(1), SPI_MEM_DIN3_MODE_V, 1, SPI_MEM_DIN3_MODE_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(1), SPI_MEM_DIN0_NUM_V, 0, SPI_MEM_DIN0_NUM_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(1), SPI_MEM_DIN1_NUM_V, 0, SPI_MEM_DIN1_NUM_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(1), SPI_MEM_DIN2_NUM_V, 0, SPI_MEM_DIN2_NUM_S);
            SET_PERI_REG_BITS(SPI_MEM_DIN_NUM_REG(1), SPI_MEM_DIN3_NUM_V, 0, SPI_MEM_DIN3_NUM_S);
            REG_CLR_BIT(SPI_MEM_USER_REG(1), SPI_MEM_USR_DUMMY);
            esp_rom_spiflash_config_clk(4, 1);
#endif
#endif
            drv = 3;
            break;
