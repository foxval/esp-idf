...
mb_master_interface_t* master_interface_ptr = NULL;
...
esp_err_t mbc_master_destroy()
{
    ...
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->destroy != NULL);
...
esp_err_t mbc_master_get_cid_info(uint16_t cid, const mb_parameter_descriptor_t** param_info)
{
    esp_err_t error = ESP_OK;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->get_cid_info != NULL);
...
esp_err_t mbc_master_get_parameter(uint16_t cid, char* name, uint8_t* value, uint8_t* type)
{
    esp_err_t error = ESP_OK;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->get_parameter != NULL);
...
esp_err_t mbc_master_send_request(mb_param_request_t* request, void* data_ptr)
{
    esp_err_t error = ESP_OK;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->send_request != NULL);
...
esp_err_t mbc_master_set_descriptor(const mb_parameter_descriptor_t* descriptor, const uint16_t num_elements)
{
    esp_err_t error = ESP_OK;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->set_descriptor != NULL);
...
esp_err_t mbc_master_set_parameter(uint16_t cid, char* name, uint8_t* value, uint8_t* type)
{
    esp_err_t error = ESP_OK;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->set_parameter != NULL);
...
esp_err_t mbc_master_setup(void* comm_info)
{
    esp_err_t error = ESP_OK;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->setup != NULL);
...
esp_err_t mbc_master_start()
{
    esp_err_t error = ESP_OK;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->start != NULL);
                            ...
                            USHORT usNDiscrete)
{
    ...
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->master_reg_cb_discrete != NULL);
        ...
        USHORT usNCoils, eMBRegisterMode eMode)
{
    eMBErrorCode error = MB_ENOERR;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->master_reg_cb_coils != NULL);
        ...
        USHORT usNRegs, eMBRegisterMode eMode)
{
    eMBErrorCode error = MB_ENOERR;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->master_reg_cb_holding != NULL);
                                ...
                                USHORT usNRegs)
{
    eMBErrorCode error = MB_ENOERR;
    MB_MASTER_ASSERT(master_interface_ptr != NULL);
    MB_MASTER_ASSERT(master_interface_ptr->master_reg_cb_input != NULL);
