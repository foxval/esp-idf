 ...
 */
typedef enum {
    PAR_PERMS_READ               = 1 << 0,                              /**< the characteristic of the device are readable */
    PAR_PERMS_WRITE              = 1 << 1,                              /**< the characteristic of the device are writable*/
    PAR_PERMS_TRIGGER            = 1 << 2,                              /**< the characteristic of the device are triggerable */
...
/*!
 * \brief Modbus discriptor table parameter type defines.
 */
typedef enum
{
...
/*!
 * \brief Modbus discriptor table parameter size in bytes.
 */
typedef enum
{
 ...
 *
 * @param descriptor[in] pointer to parameter description table
 ...
 *
 * @param request[in] pointer to request structure of type mb_param_request_t
 * @param data_ptr[in] pointer to data buffer to send or received data (dependent of command field in request)
 *
 * @return
 ...
 *
 * @param cid[in] characteristic id
 ...
 *
 * @param cid[in] id of the characteristic for parameter
 * @param name[in] pointer into string name (key) of parameter (null terminated)
 * @param value[out] pointer to data buffer of parameter
 * @param type[out] parameter type associated with the name returned from parameter description table.
 *
 * @return
 ...
 * @param cid[in] id of the characteristic for parameter
 * @param name[in] pointer into string name (key) of parameter (null terminated)
 * @param value[out] pointer to data buffer of parameter (actual representation of json value field in binary form)
 * @param type[out] pointer to parameter type associated with the name returned from parameter lookup table.
 *
 * @return
