...
#include "mbcontroller.h"           // for common defines
#include "mbcontroller_slave.h"

#if CONFIG_MB_SERIAL_SLAVE_RTU_ENABLED || CONFIG_MB_SERIAL_SLAVE_ASCII_ENABLED
...
esp_err_t mbc_slave_set_descriptor(const mb_register_area_descriptor_t descr_info)
{
    MB_ASSERT(mbs_opts != NULL);
